    ...
    return (
      <div className='Development'>
        ...
        <div className='grid grid-cols-2 justify-center mx-auto text-white'>
          <a href="https://jlb2137.github.io/" target="_blank"><h1>Giphy Search Engine!</h1></a>
          <a href="https://github.com/JLB2137/Giphy-API-Project" target="_blank"><Image className="invert" src="/github.png" width={25} height={25} layout="intrinsic" /></a>
