  ...
  return (
    <div className='flex flex-col absolute top-0'>
      ...
      <div className='flex absolute top-0 text-white text-5xl h-screen w-full z-9 justify-center'>
        <h1 className='self-center'><a href='#about-me'>About Me</a></h1>
      </div>
      <div className='flex flex-col bg-black text-white z-10 text-center content-center'>
        ...
        <Image className="border-white sm:border-8 sm:h-96" width={props.personalImageWidth} height={props.personalImageHeight} src={props.profilePhoto} layout='intrinsic' />
          <h1 className='text-white font-bold text-5xl sm:text-3xl'>Jeremee Louis Bornstein</h1>
        </motion.div>
        <motion.div key="companyName" initial={initial} whileInView={final} viewport={viewport} transition={duration}>
          <h1 className='text-white text-3xl sm:text-2xl underline'><a target="_blank" rel="noreferrer" href='https://www.sonos.com/home'>Sonos, Inc.</a></h1>
        </motion.div>
        <motion.div key="jobDescription" initial={initial} whileInView={final} viewport={viewport} transition={duration}>
          <h1 className='text-white italic text-1xl sm:text-xl'>eCommerce QA Specialist</h1>
        </motion.div>
        <motion.div key="aboutMeSection" initial={initial} whileInView={final} viewport={viewport} transition={duration}>
          <p className='flex justify-center self-center lg:text-xl sm:px-2 sm:text-xl text-center lg:py-5 lg:px-5 sm:py-2 sm:px-2' id='about-me'>
