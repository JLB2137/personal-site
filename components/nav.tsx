    ...
    return (
        <div className="relative z-10">
            <div className="grid grid-cols-2 sm:grid-cols-6 font-header font-light lg:px-10 lg:py-5 sm:pt-5 sm:px-5">
                ...
                <div className="grid justify-end align-middle text-white sm:col-span-5 sm:mr-1" >
                    <div className='grid w-max align-middle'>
                        <Link href="/">
                            <a id="name" className='text-6xl font-name sm:text-5xl sm:w-fit sm:h-fit sm:-mb-4 sm:mx-auto'>JEREMEE</a>
                        </Link>
